        ...
        <form action="{{route('panel.about.update')}}" class="forms-sample" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="input-group col-xs-12">
                    <img src="{{asset($about->image ?? 'img/resimyok.webp')}}" class="w-100" alt="">
                </div>
              </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="text_2" name="text_2" value="{{$about->text_2 ?? ''}}" placeholder="İcon 2">
          </div>

          <div class="form-group">
            <label for="text_2_content">Text 2 Content</label>
            <textarea class="form-control" id="text_2_content" name="text_2_content" placeholder="Text 2 Content" rows="3">{!! $about->text_2_content ?? '' !!}</textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="text_3" name="text_3" value="{{$about->text_3 ?? ''}}" placeholder="İcon 3">
          </div>

          <div class="form-group">
            <label for="text_3_content">Text 3 Content</label>
            <textarea class="form-control" id="text_3_content" name="text_3_content" placeholder="Text 3 Content" rows="3">{!! $about->text_3_content ?? '' !!}</textarea>
          </div>
...
<script src="https://cdn.ckeditor.com/ckeditor5/38.1.1/classic/translations/tr.js"></script>
