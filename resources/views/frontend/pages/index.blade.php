  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-12 col-lg-5 text-center pl-md-5">
        <h2>{{ $settings['kampanya_title'] ?? '' }}</h2>
        <p class="post-meta mb-4">Yazan <a href="#">Kadir Karaküçük</a> <span class="block-8-sep">&bullet;</span> Haziran 23, 2023</p>
        <p>{{ $settings['kampanya_text'] ?? '' }}</p>
        <p><a href="{{ route('indirimdekiurunler') }}" class="btn btn-primary btn-sm">Şimdi Satın Al</a></p>
      </div>
    </div>
  </div>
</div>
